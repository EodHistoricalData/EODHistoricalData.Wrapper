...
namespace EOD
{
    ...
    public class API
    {
        ...
        public API(string apiKey, bool useProxy = false)
        {
            ...
            liveStockPricesAPI = new LiveStockPricesAPI(apiKey, useProxy);
            exchangesAPI = new ExchangesAPI(apiKey, useProxy);
            historicalDividendsAPI = new HistoricalDividendsAPI(apiKey, useProxy);
            macroIndicatorsAPI = new MacroIndicatorsAPI(apiKey, useProxy);
            exchangeSymbolsAPI = new ExchangeSymbolsAPI(apiKey, useProxy);
            optionalDataAPI = new OptionsDataAPI(apiKey, useProxy);
            economicEventDataAPI = new EconomicEventDataAPI(apiKey, useProxy);
            insiderTransactionsAPI = new InsiderTransactionsAPI(apiKey, useProxy);
            calendarAPI = new CalendarAPI(apiKey, useProxy);
            bondsFundamentalsAndHistoricalAPI = new BondsFundamentalsAndHistoricalAPI(apiKey, useProxy);
            bulkAPI = new BulkAPI(apiKey, useProxy);
            exchangeDetailsAPI = new ExchangeDetailsAPI(apiKey, useProxy);
            financialNewsAPI = new FinancialNewsAPI(apiKey, useProxy);
            stockMarketScreenerAPI = new StockMarketScreenerAPI(apiKey, useProxy);
            technicalIndicatorAPI = new TechnicalIndicatorAPI(apiKey, useProxy);
        }
